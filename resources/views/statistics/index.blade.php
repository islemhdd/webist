            ...
            <div class="p-6">                <div class="flex justify-between items-center mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8">
                    ...
                    <div class="bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 rounded-xl p-6 shadow-sm">
                        ...
                        </div>                        <div class="mt-4 flex justify-around text-sm">
                            <div class="text-center">
                    ...
                    <div class="bg-gradient-to-br from-orange-50 to-orange-100 dark:from-orange-900/20 dark:to-orange-800/20 rounded-xl p-6 shadow-sm">
                        ...
                        </div>                        <div class="mt-4 space-y-2 max-h-32 overflow-y-auto" id="exemptions-details-list">
                            @if($exemptionsToday->count() > 0)
                                @foreach($exemptionsToday as $index => $exemption)
                                    <div class="flex justify-between text-sm">
                                        <div class="flex items-center">
                                            <div class="w-3 h-3 rounded-full mr-2" style="background-color: {{ ['#ef4444', '#f97316', '#eab308', '#22c55e', '#3b82f6', '#8b5cf6', '#ec4899'][$index % 7] }}"></div>
                                            <span class="text-gray-700 dark:text-gray-300">{{ ucfirst($exemption->motif) }}</span>
                                        </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function updateRadioStyles() {
                gradeRadios.forEach(radio => {
                    ...
                    if (radio.checked) {
                        customDiv.classList.remove('bg-gray-100', 'dark:bg-gray-700', 'border-gray-300', 'dark:border-gray-600');
                        customDiv.classList.add('bg-blue-500', 'border-blue-500', 'shadow-lg', 'transform', 'scale-105');
                        customDiv.querySelector('span').classList.remove('text-gray-700', 'dark:text-gray-300');
                        customDiv.querySelector('span').classList.add('text-white');
                    } else {
                        customDiv.classList.add('bg-gray-100', 'dark:bg-gray-700', 'border-gray-300', 'dark:border-gray-600');
                        customDiv.classList.remove('bg-blue-500', 'border-blue-500', 'shadow-lg', 'transform', 'scale-105');
                        customDiv.querySelector('span').classList.add('text-gray-700', 'dark:text-gray-300');
            ...
            function updateCharts(data) {
                ...
                if (convocationsChart) {
                    convocationsChart.data.datasets[0].data = [data.convocationsWithPsy, data.convocationsWithoutPsy];
            ...
            function updateCenterTotals(data) {
                const patientsTotal = document.querySelector('#patientsChart').parentElement.querySelector('.absolute .text-2xl');
                const appointmentsTotal = document.querySelector('#appointmentsChart').parentElement.querySelector('.absolute .text-2xl');
                const convocationsTotal = document.querySelector('#convocationsChart').parentElement.querySelector('.absolute .text-2xl');
            ...
            function updateDetailCards(data) {
                ...
                if (convocationsWithoutPsyDetail) convocationsWithoutPsyDetail.textContent = data.convocationsWithoutPsy;
            ...
            function updateExemptionsChart(exemptions) {
                ...
                if (exemptionsChart) {
                    ...
                    exemptionsChartContainer = document.querySelector('.bg-gradient-to-br.from-orange-50 .relative');
                }
                        ...
                        window.exemptionsChart = new Chart(newCanvas.getContext('2d'), {
                            ...
                            data: {
                                ...
                                datasets: [{
                                    ...
                                    backgroundColor: exemptions.map((_, index) => colors[index % 7]),
                                    borderWidth: 0
                                }]
                            },
                            options: commonOptions
