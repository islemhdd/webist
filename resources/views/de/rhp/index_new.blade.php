    ...
    <div class="max-w-7xl mx-auto bg-white rounded-lg shadow-lg mt-6  p-6">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="bg-white dark:bg-gray-800 shadow-lg rounded-xl p-6">
                ...
                <div class="mb-8">
                    <h3 class="text-xl font-semibold text-gray-900 text-center dark:text-white mb-4">Planning RHP de la semaine (Dimanche à Jeudi)</h3>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                    ...
                    <div class="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4">
                        ...
                        <div class="space-y-3">
                            @forelse($rhps->where('periode', 'matin')->sortBy('date_assignation') as $rhp)
                    ...
                    <div class="bg-orange-50 dark:bg-orange-900/20 rounded-lg p-4">
                        ...
                        <div class="space-y-3">
                            @forelse($rhps->where('periode', 'apres_midi')->sortBy('date_assignation') as $rhp)
                        ...
                        <div>
                            ...
                            <select name="officer_id" id="officer_id" required
                                ...
                                @foreach($officers as $officer)
                                    <option value="{{ $officer->id }}">{{ $officer->username }} - {{ $officer->role->name }}</option>
                                @endforeach
                            </select>
